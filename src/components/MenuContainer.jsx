          ...
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                }  w-24 min-w-[94px] h-28  hover:bg-red-500 cursor-pointer rounded-lg drop-shadow-xl flex flex-col gap-3 items-center justify-center  `}
                  ...
                  <IoFastFood
                    className={`${
                      filter === category.urlParamName
                        ? "text-textColor"
                        : "text-white"
                    } "bg-red-500" : "bg-card" group-hover:text-textColor text-lg `}
                  />
                </div>
                <p
                  className={`text-sm ${
