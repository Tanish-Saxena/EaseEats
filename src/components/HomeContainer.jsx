    ...
    >
      <div className=" py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
          ...
          maiores non, voluptate hic corrupti facilis repellendus minus. Ad illo
          inventore dolores voluptas itaque vero animi sit quod assumenda
          voluptate?
        </p>
        <button
          type="button"
          className="bg-gradient-to-br from-orange-400 to-orange-500 w-full md:w-auto px-4 py-2 rounded-lg hover:shadow-xl transition-all ease-in-out duration-100"
        >
          Order Now
        </button>
      </div>
